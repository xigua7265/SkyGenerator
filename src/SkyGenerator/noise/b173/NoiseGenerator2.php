...
class NoiseGenerator2 {
    ...
    private static function grad($hash, $x, $y) {
        $h = $hash & 15;
        $u = $h < 8 ? $x : $y;
    ...
    public function generateNoise(&$adouble, $d0, $d1, $i, $j, $d2, $d3, $d4) {
        ...
        for ($l = 0; $l < $i; ++$l) {
            ...
            for ($i1 = 0; $i1 < $j; ++$i1) {
                ...
                $d18 = $d17 < 0.0 ? 0.0 : ($d17 *= $d17) * $d17 * self::grad($j2, $d11, $d12);

                $d19 = 0.5 - $d13 * $d13 - $d14 * $d14;
                $d20 = $d19 < 0.0 ? 0.0 : ($d19 *= $d19) * $d19 * self::grad($k2, $d13, $d14);

                $d21 = 0.5 - $d15 * $d15 - $d16 * $d16;
                $d22 = $d21 < 0.0 ? 0.0 : ($d21 *= $d21) * $d21 * self::grad($l2, $d15, $d16);
